...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const char* pszTimestamp = "Breivika 27. Desember 2020";
    const CScript genesisOutputScript = CScript() << ParseHex("04413b87417fd62b68268738d7df59538dfb969814c785e818fd84458db101464e8c42d0a44287c801adceb7607406d96339a054035581a47ddaab484672f41966") << OP_CHECKSIG;
...
*/
        ...
        consensus.nPowTargetTimespan = 1 * 60 * 60; // 1h * 60m * 60s = 1 hour
	...
	consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000000100010001");
        ...
        //genesis = gCreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 50 * COIN);
        genesis = CreateGenesisBlock(1609104902, 170454944, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"));
        //assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));

        assert(consensus.hashGenesisBlock == uint256S("0x000000001e7ab512cfed18134209c68ec9e2514234c34f8fc1cde39a7544db45"));
        assert(genesis.hashMerkleRoot == uint256S("0x6f84bf817fbfbcf77601d3e1b1da116fd6d2406f9ac755a47adf902daef6d199"));
...
*/
	...
	//consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000001db6ec4ac88cf2272c6");
        ...
        genesis = CreateGenesisBlock(1609117735, 1532845457, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943"));
        //assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        assert(consensus.hashGenesisBlock == uint256S("0x000000006c8c8ea72cd544209aa62451193998045bb85381ee2300ea716d5e2f"));
        assert(genesis.hashMerkleRoot == uint256S("0x6f84bf817fbfbcf77601d3e1b1da116fd6d2406f9ac755a47adf902daef6d199"));
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1609147892, 2791251701, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"));
        //assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        assert(consensus.hashGenesisBlock == uint256S("0x0000000041f5c1e92d7a9a4b9194bc567d79fcaea3bc4e2a22d78b7741e04da6"));
        assert(genesis.hashMerkleRoot == uint256S("0xb7faa2b796685c2a3a6a68612e40b8bc9388857001d5f384209a2b0d98b0859a"));

...
const std::string CURRENCY_UNIT = "MTC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    MTC_KVB,      //!< Use NTC/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from MTC/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::MTC_KVB) const;
